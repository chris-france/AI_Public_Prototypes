      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-16">
        <div className="flex items-center gap-3">
          ...
          <div className="text-white">
            <span className="font-bold text-lg tracking-tight">Datacenter Demand Simulator</span>
            <span className="hidden sm:inline text-white/70 text-xs ml-2">port 8602</span>
          </div>
        </div>
      </div>
